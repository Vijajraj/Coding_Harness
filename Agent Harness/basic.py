...
def call_llm(messages, tools=None):
    ...
    completion_details = getattr(usage_details, "completion_tokens_details", None)
    prompt_details = getattr(usage_details, "prompt_tokens_details", None)

    usage = {
        "prompt_tokens": getattr(usage_details, "prompt_tokens", None),
        "completion_tokens": getattr(usage_details, "completion_tokens", None),
